...
describe('Database Types - CompensationRecord', () => {
  it('constructs valid row', () => {
    const comp: CompensationRecord = {
      ...
      currency: 'USD', salary_frequency: 'annual',
      bonus_amount: 10000, bonus_type: 'performance',
      total_compensation: 110000,
      hr3_sync_id: null, hr3_synced_at: null,
      created_at: '2025-01-01', updated_at: '2025-01-01',
    };
    expect(comp.total_compensation).toBe(110000);
  });
});
...
describe('Database Types - OnboardingTask', () => {
  it('constructs valid row', () => {
    const task: OnboardingTask = {
      ...
      task_name: 'Setup laptop', description: 'Configure dev environment',
      category: 'it', assigned_to: 'emp-2',
...
describe('Database Types - Workflow', () => {
  it('constructs valid row', () => {
    const wf: Workflow = {
      ...
      initiator_id: 'emp-1', status: 'pending',
...
describe('Database Types - ApprovalStep', () => {
  it('constructs valid row', () => {
    const step: ApprovalStep = {
      ...
      approver_id: 'emp-2', approver_role: 'manager',
      status: 'approved', comments: 'Looks good',
      acted_at: '2025-01-05', due_date: '2025-01-10',
      escalated_to: null, escalated_at: null,
...
describe('Database Types - AuditEvent', () => {
  it('constructs valid row', () => {
    const event: AuditEvent = {
      ...
      user_agent: 'Mozilla/5.0', created_at: '2025-01-01',
    };
